...
def get_start_keyboard():
    ...
    buttons = [
        [types.InlineKeyboardButton(text = "Добавить слово"              , callback_data=f"{prefix}next"),
         types.InlineKeyboardButton(text = "Начать изучение"             , callback_data=f"{prefix}learn")],
         [types.InlineKeyboardButton(text= "Повторить то что учил ранее" , callback_data=f"{prefix}repeat"),
         types.InlineKeyboardButton(text = "Повторить трудные слова"     , callback_data=f"{prefix}repeat_difficult")]
         ]
