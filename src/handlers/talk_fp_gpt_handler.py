...
from src.fsm.talk_fp_gpt_fcm import TalkFPGPTFCM as FCM
...
async def cmd_fm(cbq: types.CallbackQuery, state: FSMContext, data_session_collector: DataSessionCollector):
...
async def cmd_msg_fm(msg: types.message, state: FSMContext, data_session_collector: DataSessionCollector):
